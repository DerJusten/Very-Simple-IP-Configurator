    ...
    public class CustomGroupBox : GroupBox
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Enabled)
                ...
                using (Brush aBrush = new SolidBrush(CustomTheme.GetLabelColor()))
                {
                    if (Enabled)
                        DrawGroupBox(e.Graphics, CustomTheme.GetLabelColor(), Color.LightGray);
                    else
                        DrawGroupBox(e.Graphics, CustomTheme.GetLabelColor(), Color.Gray); ;
                }
        }
