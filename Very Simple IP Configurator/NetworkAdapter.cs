namespace ROOT.CIMV2.Win32
{
    ...
    // Eine für die WMI-Klasse generierte Klasse mit früher Bindung.Win32_NetworkAdapter
    public class NetworkAdapter : System.ComponentModel.Component
    {
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"AdapterType\" gibt das verwendete Netzwerkmedium an. Diese Eigens" +
            "chaft ist möglicherweise nicht für alle in dieser Klasse aufgeführten Netzwerkad" +
            "apter verfügbar. Nur Windows NT.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""AdapterTypeId"" zeigt das verwendete Netzwerkmedium an. Diese Eigenschaft zeigt dieselben Informationen wie die Eigenschaft ""AdapterType"" an, allerdings werden die Informationen in den folgenden ganzzahligen Werten zurückgegeben: 
0 - Ethernet 802.3
1 - Token Ring 802.5
2 - FDDI (Fiber Distributed Data Interface)
3 - WAN (Wide Area Network)
4 - LocalTalk
5 - Ethernet mit DIX-Headerformat
6 - ARCNET
7 - ARCNET (878.2)
8 - ATM
9 - Drahtlos
...
12 - CoWan
13 - 1394
Diese Eigenschaft gilt nicht für alle in dieser Klasse aufgeführten Netzwerkadaptertypen. Sie gilt nur für Windows NT.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"DeviceID\" enthält eine Zeichenfolge, die den Netzwerkadapter von" +
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die \"GUID\"-Eigenschaft gibt die global eindeutige ID (GUID) für die Verbindung an" +
            ".")]
        public string GUID
        {
            get
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Index\" gibt die Indexnummer des Netzwerkadapters an, die in der " +
            "Systemregistrierung gespeichert ist.\nBeispiel: 0.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        public uint Index
        {
            get
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Eigenschaft ""Installed"" gibt an, ob der Netzwerkadapter installiert ist.
Werte: TRUE oder FALSE. TRUE gibt an, dass der Netzwerkadapter installiert ist. 
Die Eigenschaft ""Installed"" wurde abgelehnt. Es gibt keinen Ersatzwert und diese Eigenschaft wird jetzt als überflüssig angesehen.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"MACAddress\" gibt die MAC-Adresse des Netzwerkadapters an. Eine M" +
            "AC-Adresse ist eine eindeutige 48-Bit Nummer, die dem Netzwerkadapter vom Herste" +
            "ller zugewiesen und für die TCP/IP-Kommunikation verwendet wird.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"Manufacturer\" gibt den Hersteller des Netzwerkadapters an.\nBeisp" +
            "iel: 3COM.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"MaxNumberControlled\" gibt die maximale Anzahl der direkt adressi" +
            "erbaren Anschlüsse an, die von diesem Netzwerkadapter unterstützt werden. Geben " +
            "Sie 0 ein, wenn der Wert unbekannt ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"NetConnectionID\" bestimmt den Namen der Netzwerkverbindung, so w" +
            "ie er im Ordner \"Netzwerkverbindungen\" angezeigt wird.")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description(@"Die Zeichenfolge ""NetConnectionStatus"" zeigt den Verbindungsstatus des Netzwerkadapters und dem Netzwerk an. Der Wert der Eigenschaft hat die folgenden Bedeutungen:
...
.. - Andere - Informationen zu anderen als den oben aufgeführten ganzzahligen Werte finden Sie in der Win32-Fehlercodedokumentation.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die \"NetEnabled\"-Eigenschaft gibt an, ob die Netzwerkverbindung aktiviert ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die \"PhysicalAdapter\"-Eigenschaft gibt an, ob der Adapter ein physikalischer oder" +
            " ein logischer Adapter ist.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"ProductName\" gibt den Produktnamen des Netzwerkadapters an.\nBeis" +
            "piel: Fast EtherLink XL")]
        ...
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        [Description("Die Eigenschaft \"TimeOfLastReset\" gibt an, wann der Netzwerkadapter zuletzt zurüc" +
            "kgesetzt wurde.")]
        [TypeConverter(typeof(WMIValueTypeConverter))]
        ...
        public enum AdapterTypeIdValues
        {
            ...
            Ethernet_mit_DIX_Headerformat = 5,
